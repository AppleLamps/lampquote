...
Get your API key at [poe.com/api/keys](https://poe.com/api/keys). Most current models from major providers support tool calling, including [GPT-5.4](https://poe.com/GPT-5.4) (by OpenAI), [Gemini-3-Pro](https://poe.com/Gemini-3-Pro) (by Google), and [Claude-Opus-4.6](https://poe.com/Claude-Opus-4.6) (by Anthropic).

API Key:

Model:GPT-5.2Gemini-3-ProClaude-Opus-4.5

Use environment variable

```
POE_API_KEY = "YOUR_POE_API_KEY"  # poe.com/api/keys
MODEL = "GPT-5.2"
```
