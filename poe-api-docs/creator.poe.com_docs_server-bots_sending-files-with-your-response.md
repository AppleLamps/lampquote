---
url: "https://creator.poe.com/docs/server-bots/sending-files-with-your-response"
title: "Sending files with your response | Poe Creator Platform"
---
...
### [**Parameters**](https://creator.poe.com/docs/server-bots/sending-files-with-your-response\#parameters)
...
### [**Example**](https://creator.poe.com/docs/server-bots/sending-files-with-your-response\#example)
...
### [**Notes**](https://creator.poe.com/docs/server-bots/sending-files-with-your-response\#notes)
...
[**Parameters**](https://creator.poe.com/docs/server-bots/sending-files-with-your-response#parameters) [**Example**](https://creator.poe.com/docs/server-bots/sending-files-with-your-response#example) [**Notes**](https://creator.poe.com/docs/server-bots/sending-files-with-your-response#notes)